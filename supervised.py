...
def train(args, io):
    train_dataloader = DataLoader(ModelNet40Align('train'), batch_size=args.batch_size, num_workers=4, shuffle=True)
...
if __name__ == "__main__":
    # Training settings
    parser = argparse.ArgumentParser(description='Supervised Point Cloud Classification')
    parser.add_argument('--exp_name', type=str, default='dpa_depthpointtranv1_supervised', metavar='N',
